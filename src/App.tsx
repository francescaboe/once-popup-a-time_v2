  ...
  return (
    <main className="container mx-auto flex flex-col items-center justify-center min-h-screen p-4">
      <div className="text-center mb-8">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">{t(STORY[storyIndex].title)}</h2>
      ...
      <div className="flex space-x-4">
        <button
          className="hidden md:block px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" onClick={handlePrevClick}>
          {t('prev')}
        </button>
        <button
          className="hidden md:block px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" onClick={handleNextClick}>
          {t('next')}
        </button>
      </div>
    </main>
